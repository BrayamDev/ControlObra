            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="table__data"><?php echo $Concepto; ?></td>
                        <td class="table__data"><?php echo $Subconcepto; ?></td>
                        <td class="table__data"><?php echo $importePesosEstimacion; ?></td>
                        <td class="table__data"><?php echo $amortPesosEstimacion; ?></td>
                        <td class="table__data"><?php echo $fgPesosEstimacion; ?></td>
                        <td class="table__data"><?php echo $importePagado; ?></td>
                        <td class="table__data">
