    ...
    <div class="p-2 text-white text-center" style="background-color: #3C4857;">
        <div class="container">
            ...
            <div class="row p-2">
                <div class="col">
                    <div class="input-group">
                        <a class="form-control btn btn-primary">Cargar estimacion dolares</a>
                    </div>
                </div>
                <div class="col">
                    <div class="input-group">
                        <a class="form-control btn btn-primary">Eliminar estimacion dolares</a>
                    </div>
                </div>
            </div>
