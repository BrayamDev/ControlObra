...
while ($datos_reporte = mysqli_fetch_array($resultadoContratista)) {    
   ...
   $pdf->MultiCell(140, 5, utf8_decode($datos_reporte['actividad']), 1, 0,);
   $pdf->Cell(40, 5, utf8_decode($datos_reporte['fechaInicial']), 1, 0, 'C', 0);
   $pdf->Cell(40, 5, utf8_decode($datos_reporte['fechaFinal']), 1, 0, 'C', 0);
   $pdf->Cell(40, 5, utf8_decode($datos_reporte['responsableActividad']), 1, 0, 'C', 0);
   $pdf->Cell(40, 5, utf8_decode($datos_reporte['fechaRegistro']), 1, 1, 'C', 0);
}
