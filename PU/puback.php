...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST["btninsertarMat1"])) {
            ...
            $CantidadMatp = $_POST["cantidadp"];
            if ($CantidadMatp == "") {
                $CantidadMatp = 0;
            }
            $CantidadMatd = $_POST["cantidadd"];
            if ($CantidadMatd == "") {
                $CantidadMatd = 0;
            }
    ...
    <div class="container">
        <table class="table text-center" id="idTabla">
            <thead class="table table-dark">
                ...
                ?>
                <h2 class="container text-center"> <?php echo ucwords($_SESSION['subtitulo']); ?></h2>
                <?php
                ?>
                <h2 class="container text-center"> ( <?php  echo $Unidad; ?> )</h2>
                <tr>
                    <th>Concepto</th>
                    <th>Unidad</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <th>
                            <a href="EliminarPresupuestoPu.php?id_presupuestopu=<?php echo $idPrespuestoPU ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
