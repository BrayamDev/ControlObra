...
<body>
    <form action="importarPresupuestoDolares.php" method="POST">
        ...
        <div class="text-center p-2" style="background-color: #3C4857;">
            <button class="btn btn-outline-light btn-sm" name="btnInsertarEstimacionDolares1" type="submit">Desplegar Presupuesto</button>
            <button class="btn btn-outline-light btn-sm" name="btnInsertarEstimacionDolares" type="submit">Insertar Presupuesto</button>
            <!-- Modal -->
