...
<?php include("../Global/Header.php") ?>
    <div class="control__partida--links">
        <nav>
            <form action="../presupuesto/desplegarpresupuesto.php" method="POST">
    ...
    <div class="container">
        <table class="table text-center" id="idTabla">
            ...
            <tbody>
                ...
                $resultadoEstimacion = mysqli_query($conexion, "SELECT * FROM estimaciondet WHERE id_obra = '$idObra' AND id_contrato = '$idContrato'");
                while ($consulta1 = mysqli_fetch_array($resultadoEstimacion)) {
                    $Concepto = $consulta1['concepto'];
                    $Unidad = $consulta1['unidad'];
                    $Cantidad = $consulta1['cantidadpesos'];
                    $PuPesos = $consulta1['pupesos'];
                    $ImportePesos = $consulta1['importe_pesos'];
                    $SumaImportePesos = $SumaImportePesos +  $ImportePesos;

                ?>
                    <tr>
                        <td class="table__data"><?php echo $Concepto; ?></td>
                        <td class="table__data"><?php echo $Unidad; ?></td>
                        <td class="table__data"><?php echo $Cantidad; ?></td>
                        <td class="table__data"><?php echo $PuPesos; ?></td>
                ...
                <tr>
                        ...
                        <td class="table__data"></td>
                        <td class="table__data"></td>
                        <td class="table__data"><?php echo $SumaImportePesos; ?></td>
                        <td class="table__data"></td>
                        <td class="table__data"></td>
                    </tr>
